...
from core.orchestrator import run_subdomain_enumeration_phase, run_host_discovery_phase, run_crawling_phase
...
def load_config(config_path='config.yaml'):
    ...
    try:
        ...
        # If the YAML file is empty, yaml.safe_load returns None.
        # We'll default to an empty dictionary in that case to prevent errors.
        if config is None:
            config = {}
...
def main_menu(domain, config):
    ...
    while True:
        ...
        console.print("  [bold cyan]6.[/bold cyan] Phase 4: Vulnerability Scanning (Coming Soon)")
        console.print("  [bold blue]---------------------------------------------[/bold blue]")
        ...
        if choice == '1':
            ...
            console.print("\n[bold magenta]*** Full Scan Workflow Complete (more phases coming soon) ***[/bold magenta]")
